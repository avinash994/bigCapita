...
<body>
  ...
  <form method="POST" action="AuditServlet">
    	...
    	<div class="leftcontact">
			      ...
			      <div class="form-group">
			        ...
			        <span class="icon-case"><i class="fa fa-male"></i></span>
				        <input type="text" name="userId" id="nom" data-rule="required" value ="${companyId.userName}"  required data-msg="Vérifiez votre saisie sur les champs : Le champ 'Nom' doit être renseigné."/>
